...
local function onPlayerAdded(player)
	...
	local transactions = TransactionManager:LoadTransactions(player)
	if #transactions == 0 then
		TransactionManager:MigrateExistingPortfolio(player)
	end
end
